...
var localizations = map[string]string{
	...
	"en-US.btn.done":                                     "Done",
	"en-US.btn.edit":                                     "Edit",
	"en-US.btn.end_session":                              "End session",
	"en-US.btn.login":                                    "Sign in",
	"en-US.btn.logout":                                   "Sign out",
	"en-US.btn.new":                                      "Add new",
	"en-US.btn.new_patient":                              "Add new",
	"en-US.btn.new_user":                                 "New",
	"en-US.btn.open":                                     "Open",
	"en-US.btn.pause_session":                            "Pause session",
	"en-US.btn.remove":                                   "Remove",
	"en-US.btn.reschedule":                               "Reschedule",
	"en-US.btn.save":                                     "Save",
	"en-US.btn.sign_in":                                  "Sign in",
	"en-US.btn.signup":                                   "Sign up",
	"en-US.btn.start_session":                            "Start session",
	...
	"en-US.email.confirm_email_body":                     "Confirm your email by clicking the link below:",
	"en-US.email.confirm_email_cta":                      "Confirm my email",
	"en-US.email.confirm_email_subject":                  "Confirm your email",
	"en-US.email.greeting":                               "Hello",
	"en-US.email.i_want_to":                              "I want to:",
	"en-US.email.reschudule_appointment":                 "Reschudule my appointment",
	"en-US.email.reset_password_body":                    "You can reset your password by clicking the link below:",
	"en-US.email.reset_password_cta":                     "Reset my password",
	"en-US.email.reset_password_subject":                 "Reset your password",
	...
	"en-US.str.add_clinic":                               "Add clinic",
	"en-US.str.add_patient":                              "Add patient",
	...
	"en-US.str.apnt_step_4":                              "Step 4",
	"en-US.str.apnt_step_4_desc":                         "Review notification channels",
	"en-US.str.appointment":                              "Appointment",
	"en-US.str.appointment_confirmed":                    "Your appointment has been confirmed.",
	"en-US.str.appointment_confirmed_desc":               "Thanks for confirming. Here are your appointment details.",
	...
	"en-US.str.appt_need_changes":                        "Need changes?",
	...
	"en-US.str.cancel_appointment_confirmation":          "What changes do you need?",
	...
	"en-US.str.conclusions_ph":                           "",
	"en-US.str.confirmed":                                "confirmed",
	"en-US.str.cost":                                     "Cost",
	"en-US.str.cover_photo":                              "Cover photo",
	"en-US.str.create_account":                           "Create account",
	...
	"en-US.str.enter_your_email_account":                 "Enter the email associated with your account",
	"en-US.str.exp_rev":                                  "Expents/Revenue",
	"en-US.str.facebook":                                 "Facebook",
	"en-US.str.failed_to_update":                         "Update failed, try again",
	...
	"en-US.str.feed_by":                                  "by",
	"en-US.str.feed_canceled":                            "canceled",
	"en-US.str.feed_completed":                           "completed",
	"en-US.str.feed_confirmed":                           "confirmed",
	"en-US.str.feed_created":                             "created",
	"en-US.str.feed_deleted":                             "deleted",
	"en-US.str.feed_for":                                 "for",
	"en-US.str.feed_new_appointment":                     "New appointment",
	"en-US.str.feed_on":                                  "on",
	"en-US.str.feed_updated":                             "updated",
	"en-US.str.first_name":                               "First name",
	"en-US.str.forgot_password":                          "Forgot password?",
	"en-US.str.in_progress":                              "in progress",
	...
	"en-US.str.login":                                    "Sign in",
	"en-US.str.login_instead":                            "Sign in instead",
	"en-US.str.logout":                                   "Sign out",
	...
	"en-US.str.my_profile":                               "My profile",
	"en-US.str.name":                                     "Name",
	"en-US.str.new_appointment":                          "New appointment",
	"en-US.str.new_clinic":                               "New clinic",
	"en-US.str.new_patient":                              "New patient",
	"en-US.str.no_clinics_found":                         "No clinics found",
	"en-US.str.no_patients_found":                        "No patients found",
	"en-US.str.no_prev_apnt":                             "No previous appointments.",
	"en-US.str.no_recent_activity":                       "No recent activity",
	...
	"en-US.str.reschedule_in":                            "Reschedule in",
	"en-US.str.reset_my_password":                        "Reset my password",
	"en-US.str.revenue_month":                            "Revenue this month",
	"en-US.str.save":                                     "Save",
	"en-US.str.search_appointments":                      "Search appointments",
	"en-US.str.search_clinics":                           "Search clinics",
	"en-US.str.search_patients":                          "Search patients",
	"en-US.str.search_users":                             "Search users",
	"en-US.str.send_password_reset":                      "Send email",
	...
	"en-US.str.signup":                                   "Sign up",
	"en-US.str.social_media":                             "Social media",
	"en-US.str.social_media_desc":                        "All social networks you want to link to your clinic.",
	...
	"en-US.str.users":                                    "Users",
	"en-US.str.view_appt":                                "View appointments",
	"en-US.str.view_more":                                "View more",
	"en-US.str.viewed":                                   "viewed",
	"en-US.str.whatsapp":                                 "Whatsapp",
	"en-US.str.yes_cancel_my_appointment":                "Cancel my appointment",
	...
	"es-MX.btn.start_session":                            "Comenzar sesion",
	...
	"es-MX.email.confirm_email_body":                     "Confirma tu correo haciendo clic en el siguiente enlace:",
	"es-MX.email.confirm_email_cta":                      "Confirmar mi correo",
	"es-MX.email.confirm_email_subject":                  "Confirma tu correo electronico",
	"es-MX.email.greeting":                               "Hola",
	"es-MX.email.i_want_to":                              "Me gustaria:",
	"es-MX.email.reschudule_appointment":                 "Reagendar mi cita",
	"es-MX.email.reset_password_body":                    "Puedes restablecer tu contrasena haciendo clic en el siguiente enlace:",
	"es-MX.email.reset_password_cta":                     "Restablecer mi contrasena",
	"es-MX.email.reset_password_subject":                 "Restablece tu contrasena",
	...
	"es-MX.str.add_clinic":                               "Agregar consultorio",
	"es-MX.str.add_patient":                              "Agregar paciente",
	...
	"es-MX.str.address_state_province":                   "Estado / Provincia",
	...
	"es-MX.str.apnt_step_4":                              "Paso 4",
	"es-MX.str.apnt_step_4_desc":                         "Revisa los canales de notificacion",
	"es-MX.str.appointment":                              "Cita",
	"es-MX.str.appointment_confirmed":                    "Tu cita ha sido confirmada.",
	"es-MX.str.appointment_confirmed_desc":               "Gracias por confirmar. Estos son los detalles de tu cita.",
	...
	"es-MX.str.appt_need_changes":                        "Necesitas cambios?",
	...
	"es-MX.str.cancel_appointment_confirmation":          "Que cambios necesitas?",
	...
	"es-MX.str.create_an_account":                        "Crear una cuenta",
	...
	"es-MX.str.failed_to_update":                         "Los datos no se guardaron correctamente",
	...
	"es-MX.str.feed_by":                                  "por",
	"es-MX.str.feed_canceled":                            "cancelada",
	"es-MX.str.feed_completed":                           "completada",
	"es-MX.str.feed_confirmed":                           "confirmada",
	"es-MX.str.feed_created":                             "agendada",
	"es-MX.str.feed_deleted":                             "eliminada",
	"es-MX.str.feed_for":                                 "para",
	"es-MX.str.feed_new_appointment":                     "Nueva cita",
	"es-MX.str.feed_on":                                  "el",
	"es-MX.str.feed_updated":                             "actualizada",
	"es-MX.str.first_name":                               "Nombres",
	"es-MX.str.forgot_password":                          "Olvidaste tu  contraseña?",
	"es-MX.str.in_progress":                              "en progreso",
	"es-MX.str.increased_by":                             "Incremento de",
	"es-MX.str.instagram":                                "Instagram",
	"es-MX.str.keep_me_signed_in":                        "Manten mi sesion activa",
	"es-MX.str.landing_hero_desc":                        "Gestiona tus citas y consultorios, da seguimiento a tus pacientes y administra tus ingresos.",
	"es-MX.str.landing_hero_title":                       "Confirmaciones y notificaciones de citas",
	...
	"es-MX.str.my_profile":                               "Mis datos",
	"es-MX.str.name":                                     "Nombre",
	"es-MX.str.new_appointment":                          "Nueva cita",
	"es-MX.str.new_clinic":                               "Nuevo consultorio",
	"es-MX.str.new_patient":                              "Paciente nuevo",
	"es-MX.str.no_clinics_found":                         "No se encontraron consultorios",
	"es-MX.str.no_patients_found":                        "No se encontraron pacientes",
	"es-MX.str.no_prev_apnt":                             "No hay citas previas.",
	"es-MX.str.no_recent_activity":                       "Sin actividad reciente",
	...
	"es-MX.str.users":                                    "Usuarios",
	"es-MX.str.view_appt":                                "Ver citas",
	"es-MX.str.view_more":                                "Ver mas",
	"es-MX.str.viewed":                                   "vista",
	"es-MX.str.whatsapp":                                 "Whatsapp",
	"es-MX.str.yes_cancel_my_appointment":                "Cancelar mi cita",
}
